...
hours_day = st.selectbox("How many hours a day do you heat your home in average?", np.arange(1, 25, 1))
...
for i, row in reading_degree_days_2022.iloc[:365].iterrows():
    ...
    energy_day_well = calculate_energy_consumption.main(property_info, temp_gap, month, heating_settings["hours"], insulation)
